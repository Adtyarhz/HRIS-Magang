...
">
    ...
    ">
        ...
        <div style="display: flex; justify-content: center; gap: 16px; margin-top: 24px;">
            ...
            @if($useFormId)
                <!-- If useFormId is provided, call JS to submit that form (so its inputs are included) -->
                <button type="button" onclick="submitFormFromModal('{{ $useFormId }}','{{ $modalId }}')"
                    style="width: 120px; height: 44px; background: #F9FCE6; border-radius: 8px; font-size: 14px; font-family: Inter, sans-serif; font-weight: 500; border: 1px solid rgba(0, 0, 0, 0.2);">
                    Yes
                </button>
            @else
...
@push('scripts')
    <script>
        ...
        function submitFormFromModal(formId, modalId) {
