...
">
            <div style="width: 100%;">
                ...
                {{-- Login Title --}}
                <h2
                    style="text-align: center; font-size: 36px; font-weight: 800; font-family: Oswald, sans-serif; margin-bottom: 32px;">
                    Login</h2>
                ...
                <form method="POST" action="{{ route('login.submit') }}">
                    ...
                    <div class="mb-4" style="margin-bottom: 20px;">
                        <label for="login" style="font-size: 12px; color: #333; padding-left: 8px;">Username atau
                            Email</label>
                        <input type="text" name="login" id="username" placeholder="Enter username"
                            value="{{ old('name') }}"
                            style="width: 100%; background: #F2F2F2; border: 1px solid #E5E5E5; border-radius: 6px; height: 44px; padding: 0 14px; font-size: 14px; color: #333;"
                            required>
                    </div>
