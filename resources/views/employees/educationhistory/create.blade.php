...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <i class="fas fa-graduation-cap fa-fw mr-2"></i>Add Education History
    </h1>
...
<div class="card shadow mb-4 border-top-0" style="border-top-left-radius: 0; border-top-right-radius: 0;">
    <div class="card-body">
        <form action="{{ route('employees.educationhistory.store', $employee) }}" method="POST" id="createForm">
            @csrf
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-12 text-right">
                            <a href="{{ route('employees.educationhistory.index', $employee) }}" class="btn btn-secondary mr-2">Cancel</a>
                            <button type="submit" class="btn btn-primary px-4">Submit History</button>
                        </div>
                    </div>
                </div>
            </div>
